    ...
    <Router>
          <nav className="main-navbar">
              ...
              {isLoggedIn && userType !== 'Staff' && user && (
                  <>
                      {/* YOUR NEW SHOP LINK FOR USERS */}
                      <Link to="/shop" className="navbar-link" onClick={e => e.currentTarget.blur()}>
                          Shop
                      </Link>
                      <Link to="/marketplace" className="navbar-link" onClick={e => e.currentTarget.blur()}>
                          Marketplace
                      </Link>

                      {/* Selling Dropdown */}
                      <div className="dropdown" onMouseEnter={() => setOpenDropdown('selling')} onMouseLeave={() => setOpenDropdown(null)}>
                          <a href="#" className="dropbtn" ref={sellingBtnRef} onClick={e => e.preventDefault()}>
                            Selling
                          </a>
                      ...
                      <div className="dropdown" onMouseEnter={() => setOpenDropdown('buying')} onMouseLeave={() => setOpenDropdown(null)}>
                          <a href="#" className="dropbtn" ref={buyingBtnRef} onClick={e => e.preventDefault()}>
                            Buying
                          </a>
                          {openDropdown === 'buying' && (
                              <div className="dropdown-content">
                      ...
                      <div className="navbar-usergroup">
                          <Link to="/cart" className="navbar-cart-link" onClick={e => e.currentTarget.blur()}>
                              <img src={CartImg} alt="Cart" className="navbar-cart-icon" />
                          </Link>
                          <Link to="/profile" className="navbar-profile-link" onClick={e => e.currentTarget.blur()}>
                              <img
